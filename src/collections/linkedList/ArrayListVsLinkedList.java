...
public class ArrayListVsLinkedList {
    public static void main(String[] args) {
        ...
        System.out.println(numbers.peek());//get first element
        System.out.println(numbers.peekFirst());//get the first
        System.out.println(numbers.poll());//retrieves first element and removes it.
        System.out.println(numbers.pollLast());
        System.out.println(numbers.pollFirst());
        System.out.println(numbers);

        numbers.push(5.7);//adds object to the first place void method don't put in system out

        System.out.println( numbers.pop());//remove the first element
        System.out.println(numbers);
        LinkedList<Double> numbers1 = new LinkedList<>();
        numbers.add(10.5);
        numbers.add(12.5);
        numbers.add(13.3);
        numbers.add(17.7);

...
public class AskForN {
    ...
    //USE FOR LOOP IDF YOU KNOW THE TERMINATION
    //USE WHILE LOOP HOW MANY TIMES ITERATION YOUR LOOP WILL BE EXECUTED
    //USE DO WHILE LOOP IF BLOCK OF CODE WILL EXECUTE AT LEAST ONCE WITHOUT CONDITION
        Example program:
